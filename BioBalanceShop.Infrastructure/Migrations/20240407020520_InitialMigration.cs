    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "02c32793-47c7-4f3b-9487-d91c2a0e4345", 0, "e8885cca-805e-45ba-8074-10b94fda340b", "admin@mail.com", true, "Admin", "User", false, null, "ADMIN@MAIL.COM", "ADMIN@MAIL.COM", "AQAAAAEAACcQAAAAECCpVDcTAMGOxlp+wIDXvR+n0AhnHy/gp9ro0joQSr6CVF0NCAz7tHU1IcPoF0s4zA==", null, false, "311c9b8c-69fa-4001-87c0-6df1927091ba", false, "admin@mail.com" },
                    { "c4f1530f-2727-4bc8-9de3-075fc7420586", 0, "9a8697c8-544c-41b7-9fc0-3f57eb551279", "customer@mail.com", true, "Ivan", "Ivanov", false, null, "CUSTOMER@MAIL.COM", "CUSTOMER@MAIL.COM", "AQAAAAEAACcQAAAAED6sZMSDXPDIh3TS9IrYe78T1PPk3SVxCFWoqNVxDUQRZYhJJpGtKy3pmnlGVGxPNg==", null, false, "8ea54be6-cfe7-49db-9fac-4094d7349128", false, "customer@mail.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 18.00m, new DateTime(2024, 4, 7, 4, 5, 19, 316, DateTimeKind.Local).AddTicks(4532), 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 18.00m, 2, 1, true, 1, new DateTime(2024, 4, 7, 4, 5, 19, 239, DateTimeKind.Local).AddTicks(624), "PO000000", 1, 1, 1.80m, 1, 19.80m });

            migrationBuilder.InsertData(
                table: "OrderItems",
                columns: new[] { "Id", "CurrencyId", "IsActive", "OrderId", "Price", "Quantity" },
                values: new object[] { 1, 2, true, 1, 12.00m, 1 });

            migrationBuilder.InsertData(
                table: "OrderItems",
                columns: new[] { "Id", "CurrencyId", "IsActive", "OrderId", "Price", "Quantity" },
                values: new object[] { 2, 2, true, 1, 6.00m, 1 });
