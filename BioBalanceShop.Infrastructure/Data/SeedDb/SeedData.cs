...
public class SeedData
{
    ...
    private void SeedProducts()
    {
        ...
        AppleCiderVinegarComplex = new Product()
        {
            ...
            Images = AppleCiderVinegarComplexImages,
            Quantity = 180,
            BasePrice = 5.00M,
            TaxRate = 20M,
            TaxAmount = 1.00M,
        ...
        WheyNourishChocolateFlavour = new Product()
        {
            ...
            Images = WheyNourishChocolateFlavourImages,
            Quantity = 300,
            BasePrice = 18.00M,
            TaxRate = 20M,
            TaxAmount = 3.60M,
        ...
        MealTimeVanillaFlavour = new Product()
        {
            ...
            Images = MealTimeVanillaFlavourImages,
            Quantity = 88,
            BasePrice = 8.50M,
            TaxRate = 20M,
            TaxAmount = 1.70M,
    ...
    private void SeedProductImages()
    {
        ...
        AppleCiderVinegarComplexImages = new List<ProductImage>()
            {
                new ProductImage()
                {
                    Id = 7,
                    Image = ConvertImageToByteArray("~/images/dbSeed/products/AppleCiderVinegarComplex_front.png"),
                    ProductId = 4
                },
                new ProductImage()
                {
                    Id = 8,
                    Image = ConvertImageToByteArray("~/images/dbSeed/products/AppleCiderVinegarComplex_back.png"),
                    ProductId = 4
                }
            };

        WheyNourishChocolateFlavourImages = new List<ProductImage>()
            {
                new ProductImage()
                {
                    Id = 9,
                    Image = ConvertImageToByteArray("~/images/dbSeed/products/WheyNourishChocolateFlavour_front.png"),
                    ProductId = 5
                }
            };

        PeaNourishImages = new List<ProductImage>()
            {
                new ProductImage()
                {
                    Id = 11,
                    Image = ConvertImageToByteArray("~/images/dbSeed/products/PeaNourish_front.png"),
                    ProductId = 6
                }
            };

        ProBioMaxImages = new List<ProductImage>()
            {
                new ProductImage()
                {
                    Id = 13,
                    Image = ConvertImageToByteArray("~/images/dbSeed/products/ProBioMax_front.png"),
                    ProductId = 7
                }
            };

        NaturaCImages = new List<ProductImage>()
            {
                new ProductImage()
                {
                    Id = 15,
                    Image = ConvertImageToByteArray("~/images/dbSeed/products/NaturaC_front.png"),
                    ProductId = 8
                },
                new ProductImage()
                {
                    Id = 16,
                    Image = ConvertImageToByteArray("~/images/dbSeed/products/NaturaC_back.png"),
                    ProductId = 8
                }
            };

        MealTimeVanillaFlavourImages = new List<ProductImage>()
            {
                new ProductImage()
                {
                    Id = 17,
                    Image = ConvertImageToByteArray("~/images/dbSeed/products/MealTimeVanillaFlavour_front.png"),
                    ProductId = 9
                },
                new ProductImage()
                {
                    Id = 18,
                    Image = ConvertImageToByteArray("~/images/dbSeed/products/MealTimeVanillaFlavour_back.png"),
                    ProductId = 9
                }
            };

        FibreAndFullImages = new List<ProductImage>()
            {
                new ProductImage()
                {
                    Id = 19,
                    Image = ConvertImageToByteArray("~/images/dbSeed/products/FibreAndFull_front.png"),
                    ProductId = 10
                },
                new ProductImage()
                {
                    Id = 20,
                    Image = ConvertImageToByteArray("~/images/dbSeed/products/FibreAndFull_back.png"),
                    ProductId = 10
                }
            };
    }
