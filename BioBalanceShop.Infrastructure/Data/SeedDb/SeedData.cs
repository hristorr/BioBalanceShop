...
public class SeedData
{
    ...
    public List<ProductImage> GreenNourishCompleteImages { get; set; }

    public List<ProductImage> MaxNourishImages { get; set; }

    public List<ProductImage> AcaiImmunoDefenceImages { get; set; }

    public List<ProductImage> AppleCiderVinegarComplexImages { get; set; }

    public List<ProductImage> WheyNourishChocolateFlavourImages { get; set; }

    public List<ProductImage> PeaNourishImages { get; set; }

    public List<ProductImage> ProBioMaxImages { get; set; }

    public List<ProductImage> NaturaCImages { get; set; }

    public List<ProductImage> MealTimeVanillaFlavourImages { get; set; }

    public List<ProductImage> FibreAndFullImages { get; set; }
    ...
    private void SeedBioBalanceShop()
    {
    ...
    //        Images = GreenNourishCompleteImages,
    //        Quantity = 100,
    //        BasePrice = 10.00M,
    //        TaxRate = 20M,
    //        TaxAmount = 2.00M,
    ...
    //        CreatedById = "385ee2ad-ea62-4029-876e-2be5e3543288",
    //        ShopId = 1
    //    };
    ...
    //        Images = AcaiImmunoDefenceImages,
    //        Quantity = 220,
    //        BasePrice = 8.00M,
    //        TaxRate = 20M,
    //        TaxAmount = 1.60M,
    ...
    //        ImageFront = ConvertImageToByteArray("~/images/dbSeed/products/AppleCiderVinegarComplex_front.png"),
    //        ImageBack = ConvertImageToByteArray("~/images/dbSeed/products/AppleCiderVinegarComplex_back.png"),
    //        Quantity = 180,
    //        BasePrice = 5.00M,
    //        TaxRate = 20.00M,
    //        TaxAmount = 1.00M,
    ...
    //        ImageFront = ConvertImageToByteArray("~/images/dbSeed/products/WheyNourishChocolateFlavour_front.png"),
    //        Quantity = 300,
    //        BasePrice = 18.00M,
    //        TaxRate = 20.00M,
    //        TaxAmount = 3.60M,
    ...
    //        ImageFront = ConvertImageToByteArray("~/images/dbSeed/products/PeaNourish_front.png"),
    //        Quantity = 98,
    //        BasePrice = 17.50M,
    //        TaxRate = 20.00M,
    //        TaxAmount = 3.50M,
    ...
    //        ImageFront = ConvertImageToByteArray("~/images/dbSeed/products/ProBioMax_front.png"),
    //        Quantity = 54,
    //        BasePrice = 12.50M,
    //        TaxRate = 20.00M,
    //        TaxAmount = 2.50M,
    ...
    //        ImageFront = ConvertImageToByteArray("~/images/dbSeed/products/NaturaC_front.png"),
    //        ImageBack = ConvertImageToByteArray("~/images/dbSeed/products/NaturaC_back.png"),
    //        Quantity = 112,
    //        BasePrice = 7.00M,
    //        TaxRate = 20.00M,
    //        TaxAmount = 1.40M,
    ...
    //        ImageFront = ConvertImageToByteArray("~/images/dbSeed/products/MealTimeVanillaFlavour_front.png"),
    //        ImageBack = ConvertImageToByteArray("~/images/dbSeed/products/MealTimeVanillaFlavour_back.png"),
    //        Quantity = 88,
    //        BasePrice = 8.50M,
    //        TaxRate = 20.00M,
    //        TaxAmount = 1.70M,
    ...
    //        ImageFront = ConvertImageToByteArray("~/images/dbSeed/products/FibreAndFull_front.png"),
    //        ImageBack = ConvertImageToByteArray("~/images/dbSeed/products/FibreAndFull_back.png"),
    //        Quantity = 133,
    //        BasePrice = 7.50M,
    //        TaxRate = 20.00M,
    //        TaxAmount = 1.50M,
    ...
    //{
    //    GreenNourishCompleteImages = new List<ProductImage>()
    //        {
    //            new ProductImage()
    //            {
    //                Id = 1,
    //                Image = ConvertImageToByteArray("~/images/dbSeed/products/GreenNourishComplete_front.png"),
    //                ProductId = 1
    //            },
    //            new ProductImage()
    //            {
    //                Id = 2,
    //                Image = ConvertImageToByteArray("~/images/dbSeed/products/GreenNourishComplete_back.png"),
    //                ProductId = 1
    //            }
    //        };

    //    MaxNourishImages = new List<ProductImage>()
    //        {
    //            new ProductImage()
    //            {
    //                Id = 3,
    //                Image = ConvertImageToByteArray("~/images/dbSeed/products/MaxNourish_front.png"),
    //                ProductId = 2
    //            },
    //            new ProductImage()
    //            {
    //                Id = 4,
    //                Image = ConvertImageToByteArray("~/images/dbSeed/products/MaxNourish_back.png"),
    //                ProductId = 2
    //            }
    //        };

    //    AcaiImmunoDefenceImages = new List<ProductImage>()
    //        {
    //            new ProductImage()
    //            {
    //                Id = 5,
    //                Image = ConvertImageToByteArray("~/images/dbSeed/products/AcaiImmunoDefence_front.png"),
    //                ProductId = 3
    //            },
    //            new ProductImage()
    //            {
    //                Id = 6,
    //                Image = ConvertImageToByteArray("~/images/dbSeed/products/AcaiImmunoDefence_back.png"),
    //                ProductId = 3
    //            }
    //        };
    //}

    //private void SeedCustomerShippingAddresses()
    //{
    //    IvanIvanovShippingAddress = new CustomerAddress()
    //    {
    //        Id = 1,
    ...
    //private void SeedCustomerBillingAddresses()
    //{
    //    IvanIvanovBillingAddress = new CustomerBillingAddress()
    //    {
    //        Id = 1,
    //        Street = "Tsarigradsko shose 45",
    //        PostCode = "1000",
    ...
    //    {
    //        Id = 1,
    //        UserId = "1d7682c2-0c37-4f1c-81b7-21d3963430d8",
    //        CustomerBillingAddressId = 1,
    //        CustomerShippingAddressId = 1
    //    };
    //}

    //private void SeedOrderShippingAddresses()
    //{
    //    IvanIvanovOrderShippingAddress = new OrderAddress()
    //    {
    //        Id = 1,
    //        Street = "Tsarigradsko shose 45",
    //        PostCode = "1000",
    ...
    //private void SeedOrderBillingAddresses()
    //{
    //    IvanIvanovOrderBillingAddress = new OrderBillingAddress()
    //    {
    //        Id = 1,
    //        Street = "Tsarigradsko shose 45",
    //        PostCode = "1000",
    ...
    //    catch (Exception ex)
    //    {
    //        throw new Exception($"Error converting image into byte array: {ex.Message}");
    //    }
